class FeedsController < ApplicationController
  ...
  def manage
    ...
    @questions = @asker.posts.where("publication_id is not null").order("created_at DESC").limit(15).map{|post| [post.id, post.publication.question, post.publication.question.answers] if post and post.publication}
