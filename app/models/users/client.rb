class Client < User
  ...
  #   dm_status = asker.send_private_message(user, message, {:long_url => long_url, :link_type => 'wisr', :include_url => true})
  # end
  ...
  #   dm_status = asker.send_private_message(user, message, {:long_url => nil, :link_type => 'wisr', :include_url => true})
  # end
