...
ActiveRecord::Schema.define(version: 20141009213610) do
  ...
  add_index "relationships", ["follower_id", "followed_id", "channel"], name: "index_relationships_on_follower_id_and_followed_id_and_channel", unique: true, using: :btree
